...
/**
 * @file include/thimble/math/all.h
 *
 * @brief
 *            Provides all the functionalities that are provided by
 *            the headers in <code>thimble/math/</code>.
 *
 * @author Benjamin Tams
 */
#ifndef THIMBLE_MATH_ALL_H_
#define THIMBLE_MATH_ALL_H_
...
#include <thimble/math/linalg/all.h>
#include <thimble/math/numbertheory/all.h>
#include <thimble/math/numerical/all.h>

#endif /* THIMBLE_MATH_ALL_H_ */
